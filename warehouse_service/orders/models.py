...
class OrderItem(models.Model):
    """
    Промежуточная модель между Order и Product.

    Назначение:
        Представляет позицию в заказе — связывает заказ с товаром и хранит
        дополнительные данные этой связи: количество и цену на момент покупки.

    Поля:
        order: Заказ, к которому относится данный товар.
        product: Товар, который входит в заказ.
